...
placeholder="email@example.com" required/> 
            ...
            <div className="mb-3"> 
                <label htmlFor="inputPassword" className="form
label">Password</label> 
                <input type="password" id="inputPassword" 
value={password} onChange={onPasswordChange} className="form
control" required/> 
            </div> 
